...
def find_optimal_parameters(data, eps_range=None, min_samples_range=None, method='silhouette'):
	"""
...
def optimize_dbscan(data, method='grid_search', **kwargs):
	"""
...
def train_dbscan(data, optimize=True, save=True, **kwargs):
	"""
...
def save_model(model, path="models/dbscan_model.pkl"):
	"""
...
def load_dbscan(model_path, scaler_path=None):
	"""
