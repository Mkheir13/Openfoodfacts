...
def load_and_prepare_data(file_path: str, nrows: int | None = None) -> pd.DataFrame:
    """
...
def test_scaling_methods(input_data: str | pd.DataFrame) -> tuple[
